...
export class relationManyToManyProductWhithCategory1623879769265 implements MigrationInterface {
    name = 'relationManyToManyProductWhithCategory1623879769265'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "category" ADD "createdAtt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "category" ADD "updatedAtt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "category" DROP COLUMN "updatedAtt"`);
        await queryRunner.query(`ALTER TABLE "category" DROP COLUMN "createdAtt"`);
